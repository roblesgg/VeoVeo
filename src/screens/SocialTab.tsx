      ...
      <View style={styles.content}>
        ...
        <View style={styles.tabContainer}>
          <View style={styles.tabRow}>
            <Pressable
              onPress={() => setTab(0)}
              style={[styles.tabBtn, tab === 0 && styles.tabOnBtn]}
            >
              <Text style={[styles.tabText, tab === 0 && styles.tabOnText, { fontFamily }]}>
                Amigos
              </Text>
            </Pressable>
            <Pressable
              onPress={() => setTab(1)}
              style={[styles.tabBtn, tab === 1 && styles.tabOnBtn]}
            >
              <Text style={[styles.tabText, tab === 1 && styles.tabOnText, { fontFamily }]}>
                Buscar
              </Text>
            </Pressable>
          </View>
