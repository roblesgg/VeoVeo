...
export const FriendRow = React.memo(
  ({ amigo, onPress, onEliminar, onBloquear, onChat, fontFamily }: Props) => {
    const statusColor =
      ...
      <View style={styles.container}>
        ...
        <View style={styles.actions}>
          ...
          <Pressable
            style={styles.iconBtn}
            onPress={() =>
              Alert.alert('Bloquear', '¿Seguro?', [
                { text: 'No' },
                { text: 'Sí', onPress: onBloquear },
              ])
            }
          >
