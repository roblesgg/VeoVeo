...
export const TierListSelector = React.memo(
  ({ peliculas, seleccionadas, onToggle, fontFamily }: Props) => {
    ...
    if (peliculas.length === 0) {
      return (
        <Text style={[styles.hint, { fontFamily }]}>No tienes películas vistas para añadir.</Text>
      );
    }
    ...
    return (
      <View style={styles.flex}>
        ...
        <View style={styles.container}>
              ...
              >
                {p.rutaPoster ? (
                  ...
                  <View style={[styles.selectPoster, styles.posterFallback]}>
                    <Text style={[styles.posterFallbackText, { fontFamily }]} numberOfLines={3}>
                      {p.titulo}
                    </Text>
                  </View>
                )}
          ...
          {filtered.length === 0 && (
            <Text style={[styles.hint, { fontFamily, width: '100%' }]}>Sin resultados</Text>
          )}
        </View>
      </View>
    );
