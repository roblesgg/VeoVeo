...
_Para evitar conflictos de "ownership" de dominio y certificados SSL duplicados._
...
_Confirmar que el tráfico ya sabe a dónde ir._
...
- [ ] **Comprobación de Propagación:**
  ...
  - _Alternativa web:_ Usa [whatsmydns.net](https://www.whatsmydns.net/#A/dripdev.dev).

---

## 🔒 Fase 3: Encendido y SSL en Vercel

_Activar el cifrado seguro en la nueva casa._
...
_Verifica que los 3 pilares del sistema funcionan en vivo._

- [ ] **Enlace 1 (Home):** [https://dripdev.dev/](https://dripdev.dev/)
  - _Resultado esperado:_ Carga la landing page con animaciones y el logo.
- [ ] **Enlace 2 (Descarga APK):** [https://dripdev.dev/veoveo-latest.apk](https://dripdev.dev/veoveo-latest.apk)
  - _Resultado esperado:_ Salta la descarga inmediata del archivo de 86MB aproximadamente.
- [ ] **Enlace 3 (Deep Linking):** [https://veoveo.dripdev.dev/share?type=movie&id=550](https://veoveo.dripdev.dev/share?type=movie&id=550)
  - _Resultado esperado:_ Carga la página de share (el diseño tipo movil) con el botón para abrir la app.
- [ ] **Bonus (AssetLinks):** [https://dripdev.dev/.well-known/assetlinks.json](https://dripdev.dev/.well-known/assetlinks.json)
  - _Resultado esperado:_ Se muestra el JSON con el SHA256 de la firma de Android.
